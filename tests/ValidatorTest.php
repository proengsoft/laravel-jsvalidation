...
class ValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $expected = [
            'rules'    => ['name' => ['laravelValidation' => [['Required',[],'name required',true]]]],
            'messages' => [],
        ];
    ...
    public function testValidationDataRemote()
    {
        ...
        $expected = [
            'rules'    => ['name' => ['laravelValidationRemote' => [['ActiveUrl',['name','encrypted token'],'active url',false]]]],
            'messages' => [],
        ];
    ...
    public function testJsRemoteCustomRule()
    {
        ...
        $expected = [
            'rules'    => ['name' => ['laravelValidationRemote' => [['Foo',['name','encrypted token'],'custom rule -replaced text-',false]]]],
            'messages' => [],
        ];
    ...
    public function testPassesRemoteFail()
    {
        ...
        $expected = [
            'rules'    => ['name' => ['laravelRequired' => []]],
            'messages' => ['name' => ['laravelRequired' => 'name required']],
        ];
        $validator = new Validator($this->translator, $data, $rules, $messages);
    ...
    public function testRequiredIfReplacement()
    {
        ...
        $expected = [
            'rules' => [
                'name' => [
                    'laravelValidation' => [['RequiredIf',['field1','value1'],'The  field is required when  is .',true]],
                ],
            ],
            'messages' => [],
        ];
    ...
    public function testMimes()
    {
        ...
        $expected = [
            'rules' => [
                'name' => ['laravelValidation' => [['Mimes',['TXT'],'Mime TXT',false]]],
            ],
            'messages' => [],
        ];
